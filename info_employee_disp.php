...
<body>
    ...
    $q_sum = mysqli_query($con, "SELECT COUNT(Leave_Log_Count) FROM leave_log WHERE SUM");


    // leave_log sum datecount แล้ว where ที่ไอดีของคนๆนั้น group by ประเภท แล้วจะ sum จำนวนทั้งหมดตามประเภทมาให้อยู้แล้ว นำชุดนี้ไปจอยก็ได้ หรือประเภทว่าลาได้กี่วัน 
    // select sum จำนวนที่ลา
